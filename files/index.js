...
const UUID = process.env.UUID || 'dd30d58e-6663-4a77-94a6-6109ea33d967'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.mybbxy.us.kg';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'dTxwV3fixTmcJMitVx';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.mlovej.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYWMwZmIwNjVhNmM4MDdjOTMxZGU0OWU0YjFlNGMwNGIiLCJ0IjoiNmIxN2Y1MWYtNTZjNC00ZTU4LWIzYzgtYTVlNjYzMjhlMmJhIiwicyI6Ik5qSmxOelppWlRZdFptSTVZaTAwTldFd0xUZ3lOVGN0WkdSbU16QTNNVFExTldGbSJ9';
const CFIP = process.env.CFIP || 'cloudflare.cdnjson.com';
